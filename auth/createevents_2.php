...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $pdo->prepare("INSERT INTO event (GroupID, PostedBy, Title, Description, EventDate, Location, RSVPCount) VALUES (:groupId, :postedBy, :title, :description, :eventDate, :location, 0)");
...
<body class="bg-gray-100">
    ...
    <nav class="bg-blue-500 p-4">
        <div class="container mx-auto flex items-center justify-between">
            <!-- Brand Name -->
            <a href="#" class="text-white text-2xl font-bold">Neighborhood Helper</a>
            
            <!-- Search Bar -->
            <div class="flex items-center">
                <input type="text" placeholder="Search events or groups" class="p-2 rounded-l-md focus:outline-none">
                <button class="bg-white text-blue-500 px-4 py-2 rounded-r-md font-bold">Search</button>
            </div>

            <!-- Navigation Links -->
            <div class="space-x-4">
                <a href="#" class="text-white font-medium">Home</a>
                <a href="#" class="text-white font-medium">My Events</a>
